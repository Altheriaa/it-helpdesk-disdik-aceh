                ...
                <div class="bay-card">
                    <div class="bay-card-header">
                        <div class="bay-icon-title-group">
                            <div>
                                <h2 class="bay-card-title">Buat Tiket Layanan IT Baru</h2>
                                <p class="bay-card-subtitle">Sampaikan kendala atau permohonan layanan IT Anda kepada tim Support Dinas Pendidikan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bay-form-actions">
                        <a href="{{ route('filament.admin.resources.tickets.index') }}" class="bay-btn-cancel">
                            Batal
                        </a>
