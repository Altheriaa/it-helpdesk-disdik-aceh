                ...
                <div class="bay-card">
                    <div class="bay-card-header">
                        <div class="bay-icon-title-group">
                            <div>
                                <h2 class="bay-card-title">Edit Tiket #{{ $ticket->ticket_number }}</h2>
                            </div>
                        </div>

                        <span class="bay-badge"
                            style="color: {{ $statusColor[$ticket->status] ?? '#64748b' }}; background: {{ $statusBg[$ticket->status] ?? '#f8fafc' }};">
                    ...
                    <div class="bay-form-actions">
                        <a href="{{ route('filament.admin.resources.tickets.view', $ticket) }}" class="bay-btn-cancel">
                            Batal
                        </a>
