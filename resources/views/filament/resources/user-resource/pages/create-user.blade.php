                ...
                <div class="bay-card">
                    <div class="bay-card-header">
                        <div class="bay-icon-title-group">
                            <div>
                                <h2 class="bay-card-title">Tambah Pengguna Baru</h2>
                                <p class="bay-card-subtitle">Lengkapi data diri, kredensial akun, hak akses role, serta
                                    unit kerja pengguna</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bay-form-actions">
                        <a href="{{ route('filament.admin.resources.users.index') }}" class="bay-btn-cancel">
                            Batal
                        </a>
